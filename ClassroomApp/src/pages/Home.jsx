        ...
        <PageLayout>
            <div className="pt-10 flex items-center justify-center gap-10 mx-16 h-[90vh]">
                <div className="w-1/2 space-y-6">
                    <h1 className="text-5xl font-semibold">Plug into digital learing with <span className="text-emerald-500 font-bold">Campus Connect</span></h1>
                    <p className="text-xl">
                    ...
                    <div className="space-x-6">
                        ...
                        <Link to="/aboutus">
                            <button className="border-2 border-white text-white px-7 py-3 rounded-md font-semibold text-lg cursor-pointer hover:bg-pink-700 transition-all ease-in-out duration-300 hover:text-white">About us</button>
                        </Link>
                    </div>
                </div>
